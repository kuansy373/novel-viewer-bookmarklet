...
<pre><code>javascript:(function(){var s=document.createElement('script');s.src='https://cdn.jsdelivr.net/gh/kuansy373/novel-viewer-bookmarklet@v1.5.2/vertical-text-size-color.js';document.body.appendChild(s);})();
</code></pre>
<br>
最初実行したときは、このような感じです。
<br><br>
...
- v1.1.ｘ: 自動スクロールスライダーの設定UIを追加。ページ切り替えの実装。font weight，font shadowの調整追加。
